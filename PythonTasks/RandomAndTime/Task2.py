...
"""
first = int(input('Число участников 1 сборной: '))
second = int(input('Число участников 2 сборной: '))
swim1 = randint(1, first)
swim2 = randint(1, second)
print('Пловец', swim1, '- пловец', swim2)
